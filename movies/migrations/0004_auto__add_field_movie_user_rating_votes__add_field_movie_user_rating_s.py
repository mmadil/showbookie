...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie.user_rating_votes'
        db.add_column('movies_movie', 'user_rating_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Movie.user_rating_score'
        db.add_column('movies_movie', 'user_rating_score',
    ...
    def backwards(self, orm):
        # Deleting field 'Movie.user_rating_votes'
        db.delete_column('movies_movie', 'user_rating_votes')

        # Deleting field 'Movie.user_rating_score'
        db.delete_column('movies_movie', 'user_rating_score')
