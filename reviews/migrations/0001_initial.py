...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomCommentManager'
        db.create_table('reviews_customcommentmanager', (
        ...
        db.send_create_signal('reviews', ['CustomCommentManager'])


    def backwards(self, orm):
        # Deleting model 'CustomCommentManager'
        db.delete_table('reviews_customcommentmanager')
    ...
    models = {
        ...
        'reviews.customcommentmanager': {
            'Meta': {'ordering': "('submit_date',)", 'object_name': 'CustomCommentManager', '_ormbases': ['comments.Comment']},
