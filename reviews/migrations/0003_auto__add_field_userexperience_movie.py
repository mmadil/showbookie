...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserExperience.movie'
        db.add_column('reviews_userexperience', 'movie',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['movies.Movie']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserExperience.movie'
        db.delete_column('reviews_userexperience', 'movie_id')
